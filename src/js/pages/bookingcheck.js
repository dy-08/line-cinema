...
export function inquiryGuest() {
    ...
    inquiryBtn.addEventListener('click', () => {
        ...
        if (inquiryName === guestData.name && inquiryBirth === guestData.birth && inquiryPassword == guestData.pw) {
...
function inquiryMovie(guestData) {
    ...
    //
    movPoster.src = 'https://image.tmdb.org/t/p/w500' + guestData.poster;
