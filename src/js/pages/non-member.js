...
export function init() {
    ...
    function loginCheck() {
        ...
        const userPw = document.getElementById('loginPassword').value.trim().toString();
        const userPw2 = document.getElementById('loginPassword2').value.trim().toString();
    ...
    function checkNumber() {
        window.open('./src/html/verify.html', 'pop', 'top=200,left=10,width=500,height=300');
    }
    ...
    function getGuestInfo() {
        ...
        if (!userName || !userBirth || !userNum || !userPw || !userPw2 || !agreeRadio.checked) return;
